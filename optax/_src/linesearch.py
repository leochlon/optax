...
"""Ultra-compact JAX implementation of the Moré-Thuente line search (<250 lines)."""

# =============================================================================
# Moré-Thuente Line Search Implementation
# =============================================================================
"""Ultra-compact JAX implementation of the Moré-Thuente line search.

This implementation provides the Moré-Thuente line search algorithm with
guaranteed sufficient decrease and strong curvature conditions. It uses
safeguarded cubic interpolation and maintains interval brackets around
...
EPSMACH = 2.220446049250313e-16  # Machine precision for numerical stability
...
class LineSearchState(NamedTuple):
  ...
  f: chex.Scalar
  g: chex.Scalar
  # Packed arrays for memory efficiency and JAX compatibility
  interval: chex.Array  # [stx, fx, gx, sty, fy, gy]
...
def mcstep_compact(interval, stp, fp, gp, bounds, brackt):
  ...
  stf, new_brackt = jax.lax.cond(
      fp > fx, case1,  # Higher function value
      lambda: jax.lax.cond(
    ...
    def update_search():
      ...
      def apply_modified():
        return (
          ...
          state.interval[1] - state.interval[0] * gtest,  # Modified fx
          state.interval[2] - gtest,          # Modified gx
